...
<body style="margin: 5px">
	...
	<div id="tb"
		...
		<div title="您的位置">您的位置：导航菜单>>任务管理>>任务维护</div>
		<hr>
		<br> 说明：
		<div>
			1、当前页面是查看所有报修记录,支持多值查询和模糊查询,没有条件则显示所有<br>
			2、删除至少选择一条记录,修改只能选择一条记录<br>
		</div>
		<br>
		<div style="color: black">相关操作：</div>
		<div title="相关操作">
			<a title="添加" href="javascript:taskAddDialog()"
				class="easyui-linkbutton" iconCls="icon-add">发布报修任务</a> <a
				title="删除" href="javascript:taskDelete()" class="easyui-linkbutton"
				iconCls="icon-cancel">删除报修记录</a><a title="导出"
				href="javascript:taskExport()" class="easyui-linkbutton"
				iconCls="icon-export" plain="">导出报修信息</a>
