...
<script type="text/javascript">
	...
	function taskSearch() {
		$('#dg').datagrid('load', {
			...
			repairTime : $("#s_repairTime").datebox("getValue"), //用户报修时间
...
<body style="margin: 5px">
	<table id="dg" title="用户信息" class="easyui-datagrid" fitColumns="true"
		pagination="true" rownumbers="true" url="taskHandIn" toolbar="#tb"
		fit="true">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th align="center" field="taskId" width="15">任务编号</th>
				<th align="center" field="userName" width="25">用户姓名</th>
				...
				<th align="center" field="repairTime" width="40">维修日期</th>
	...
	<div id="tb"
		...
		<div title="您的位置">您的位置：导航菜单>>任务管理>>上交任务</div>
		<hr>
		<br> 说明：
		<div>
			1、当前页面是查看当前用户的状态为维修中的报修记录,支持多值查询和模糊查询<br> 2、上交任务时,一次只能选择一条记录
		</div>
		<br>
		<div style="color: black">相关操作：</div>
		<div title="相关操作">
			<a href="javascript:taskReceiveDialog()" class="easyui-linkbutton"
				iconCls="icon-handIn" plain="">上交任务</a>
		</div>
		<div title="查询条件" style="padding-top: 5px">
			用户姓名：&nbsp;<input type="text" name="s_userName" id="s_userName" />&nbsp;
			&nbsp;维修日期：<input type="text" name="s_repairTime" id="s_repairTime"
				class="easyui-datebox" />&nbsp; &nbsp;用户地址：<input type="text"
				name="s_userAddress" id="s_userAddress" />&nbsp; <a title="维修"
				href="javascript:taskSearch()" class="easyui-linkbutton"
				iconCls="icon-search" plain="">查询</a>
		</div>
	</div>
	<!-- 对话框，添加，修改时弹出的对话框 -->
	<div id="dlg" class="easyui-dialog" style="width: 500px; height: 440px"
		...
		<form method="post" id="form" name="form">
			<table border="0" align="center" style="padding-top: 20px">
				...
				<tr height="5px"></tr>
				<tr>
					<td valign="top">维护人员：</td>
					<td><input type="text" name="repairer" id="repairer"
						disabled="disabled"></td>
					<td valign="top"><font color="red"></font></td>
				</tr>
				<tr height="5px"></tr>
	...
	<div id="dlg-button">
		<a href="javascript:closeDialog()" class="easyui-linkbutton"
			...
			class="easyui-linkbutton" iconCls="icon-ok">上交</a>
	</div>
</body>
</html>