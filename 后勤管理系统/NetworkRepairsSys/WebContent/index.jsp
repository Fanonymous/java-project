...
<script type="text/javascript" src='jquery-easyui-1.4.2/js_css/menu.js'>
...
<script type="text/javascript">
	...
	function time() {
		...
		document.getElementById("showTime").innerHTML = "当前时间：" + year + "年"
				+ mon + "月" + date + "日&nbsp;&nbsp;&nbsp;&nbsp;" + hour + ":"
				+ min + ":" + sec/*+"'"+"&nbsp;&nbsp;&nbsp;&nbsp;星期 "+day*/;
	...
	<div region="north"
		...
		<div align="left" style="width: 85%; float: left">
			<div style="width: 60px; float: left">
				<img alt="" src="images/bjwl.jpg" width="60px" height="58px">
			</div>
			<div align="left"
				style="font-size: 30px; width: 32%; float: left; padding-left: 25px; padding-top: 6px; color: white">宝鸡文理学院后勤报修系统</div>
