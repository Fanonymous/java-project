...
<script type="text/javascript">
	function delet(id) {
		if (confirm("您确认取消吗?")) {
			window.location.href = "${pageContext.request.contextPath}/test4?type=del&orderID="
					+ id
			return true;
		} else {
			return false;
...
<body>
	<form action="${pageContext.request.contextPath }/quxiaoSevrlet"
		method="post">
		<table width="100%" height="30%" border="1" align="center">
			...
			<c:forEach items="${orderform}" var="orderform" begin="0"
				...
				<tr>
					...
					<td>
						<div align="center">
							<a href="#" onClick=" return delet('${orderform.orderID}');">删除</a>
						</div>
					</td>
		...
		<br> <input type="submit" value="取消订单">
	</form>
</body>
</html>