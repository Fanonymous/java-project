...
<table width="100%" height="30%" border="1" align="center">
	...
	<tr>
		...
		<td width="7%">
		<div align="center"><a
				href="${pageContext.request.contextPath}/html/admin/renshiguanli/tianjiayuangong.jsp">添加员工</a></div>
		</td>
	...
	<tr align="center">  
            <td colspan="4">  
                <jsp:include page="/html/admin/renshiguanli/page.jsp"></jsp:include>  
            </td>  
        </tr>
