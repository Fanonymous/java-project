...
<form id="form1" name="form1" method="post"
	action="${pageContext.request.contextPath}/test4">
...
<table width="30%" height="80%" border="0" align="center">
	...
	<tr>
		...
		<div align="left"><input type="text" name="textfield"
			value="${employee.empDepartment}" id="textfieldId" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield2"
			value="${employee.empWork }" id="textfield2Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield3"
			value="${employee.empName} " id="textfield3Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield4"
			value="${employee.id_card }" id="textfield4Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield5"
			value="${employee.tel }" id="textfield5Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield6"
			value="${employee.empSex }" id="textfield6Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield7"
			value="${employee.bornTime} " id="textfield7Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield8"
			value="${employee.empAcademic }" id="textfield8Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield9"
			value="${employee.enterTime }" id="textfield9Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield10"
			value="${employee.workYears }" id="10" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield11"
			value="${ employee.bornLocal}" id="textfield11Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td>
		...
		<div align="left"><input type="text" name="textfield12"
			value="${employee.timeLimit }" id="textfield12Id" /></div>
		</label></td>
	</tr>
	<tr>
		<td colspan="2"><label>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="submit" name="Submit" onclick="return checkvalue();"
			value="提交" /> </label> <label> <input type="reset" name="Submit2"
			value="重置" /> </label></td>
	</tr>
</table>
</form>
